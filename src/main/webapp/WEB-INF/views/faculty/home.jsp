...
<head>
    ...
    <!-- Bootstrap core CSS -->
    <link href="resources/faculty1/css/bootstrap.css" rel="stylesheet">

    <!-- Add custom CSS here -->
    <link href="resources/faculty1/css/modern-business.css" rel="stylesheet">
    <link href="resources/faculty1/font-awesome/css/font-awesome.min.css" rel="stylesheet">
</head>
...
<div class="modal fade bs-example-modal-sm" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-sm">
    ...
    <!-- JavaScript -->
    <script src="resources/faculty1/js/jquery-1.10.2.js"></script>
    <script src="resources/faculty1/js/bootstrap.js"></script>
    <script src="resources/faculty1/js/modern-business.js"></script>
